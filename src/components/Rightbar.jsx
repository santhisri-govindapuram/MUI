import { Avatar, AvatarGroup, Box, Divider, ImageList, ImageListItem, ListItem, ListItemAvatar, ListItemText } from "@mui/material";
...
const Rightbar = () => {
    return (
        <Box flex={2} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
            <Box width={300}>
                <Typography variant="h6" fontWeight={100}>Online Frineds</Typography>
                <AvatarGroup max={7}>
